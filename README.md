...
## 📌 Project Overview
This project builds an end-to-end ETL pipeline for the Nashville Housing dataset using SQL Server. It follows a Medallion Architecture (Bronze → Silver → Gold) to clean, transform, and structure raw housing data for analytics and reporting.
